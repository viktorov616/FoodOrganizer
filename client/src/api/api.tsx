...
export const sendPasswordToken = data => (
  axios.post('/api/sendPasswordToken', data).catch(e => e.response)
);
export const changePassword = data => (
  axios.post('/api/changePassword', data).catch(e => e.response)
);
export const resetPassword = data => axios.post('/api/resetPassword', data).catch(e => e.response);
export const validateToken = data => (
  axios(`/api/validateToken?${qs.stringify(data)}`).catch(e => e.response)
);
